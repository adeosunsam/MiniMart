    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CallBackEventLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionResponseMessage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SourceAccountName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SourceBankName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SourceBankAccountNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleTransactions_Orders_SaleId",
                        column: x => x.SaleId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleTransactions_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_TransactionId",
                table: "SaleTransactions",
